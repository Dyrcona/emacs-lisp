...
(define-key super-k-map (kbd "3") (lambda () (interactive) (sql-connect "pg11")))
(define-key super-k-map (kbd "4") (lambda () (interactive) (sql-connect "pg12")))
(define-key super-k-map (kbd "5") (lambda () (interactive) (sql-connect "pg13")))
(define-key super-k-map (kbd "6") (lambda () (interactive) (sql-connect "pg14")))
(define-key super-k-map (kbd "7") (lambda () (interactive) (sql-connect "pg15")))
