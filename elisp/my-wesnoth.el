...
(setq wesnoth-root-directory my-wesnoth-source-share-dir
...
(defvar-keymap my-wesnoth-map
  :doc "Prefix map for my Wesnoth commands"
  "a" (make-find-file-command (expand-file-name my-wesnoth-add-ons-dir))
  "d" (make-find-file-command (expand-file-name my-wesnoth-stable-data-dir))
  "s" (make-find-file-command (expand-file-name "saves" my-wesnoth-stable-data-dir))
  "D" (make-find-file-command (expand-file-name my-wesnoth-dev-data-dir))
  "S" (make-find-file-command (expand-file-name "saves" my-wesnoth-dev-data-dir))
  "f" (make-find-file-command my-wesnoth-flatpak-share-dir)
  "F" (make-find-file-command my-wesnoth-source-share-dir)
  "l" (make-find-file-command (expand-file-name "logs" my-wesnoth-stable-data-dir))
  "L" (make-find-file-command (expand-file-name "logs" my-wesnoth-dev-data-dir)))
(keymap-global-set "s-w" my-wesnoth-map)
